...
impl FrameManager {
    ...
    /// NOTE: Runtime.enable removed for anti-detection (patchright-rs patch).
    /// Without Runtime.enable, execution context tracking via events is disabled.
    /// Use Page.createIsolatedWorld + Runtime.evaluate with context_id instead.
